...
const cityCreateValue = document.getElementById('cityCreate');
const phoneCreateValue = document.getElementById('phoneCreate');
    ...
    $('.btnCreate').on('click', async function (e) {
        ...
        let u = await fetch('http://localhost:8080/restCreat', {
            ...
            body: JSON.stringify({
                ...
                city: cityCreateValue.value,
                phone: phoneCreateValue.value,
        ...
        cityCreateValue.value = "";
        phoneCreateValue.value = "";
...
const cityFormEdit = document.getElementById('cityFormEdit');
const phoneFormEdit = document.getElementById('phoneFormEdit');
    ...
    $('#submitEdit').on('click', async function (e) {
        ...
        let u = await fetch('http://localhost:8080/restUpdate', {
            ...
            body: JSON.stringify({
                ...
                city: cityFormEdit.value,
                phone: phoneFormEdit.value,
